  ...
  <nav class="navbar navbar-expand-lg navbar-dark ftco_navbar bg-dark ftco-navbar-light" id="ftco-navbar">
      ...
      <div class="container">
        <div class="row no-gutters slider-text js-fullheight align-items-center justify-content-start" data-scrollax-parent="true">
          <div class="col-md-9 ftco-animate" data-scrollax=" properties: { translateY: '70%' }">
            ...
            <form action="tour.jsp" method="post" class="d-block d-flex">
                <input type="submit" class="search-submit btn btn-lg btn-primary" value="Find your dream trip">  
             </form>
    					...
    					<c:forEach  var="trip" items="${TRIP_LIST}" >
    						<div class="item">
		    					<div class="destination">
		    						<a href="${trip.desc_url }" alt="${trip.tripName }"  target="_blank" class="img d-flex justify-content-center align-items-center" style="background-image: url(${trip.img_url});">
		    							<div class="icon d-flex justify-content-center align-items-center">
		    								<span class="icon-search2"></span>
		    							</div>
		    						</a>
		    						<div class="text p-3">
		    							<h3><a href="${trip.desc_url }" alt="${trip.tripName }"  target="_blank">${trip.tripName }</a></h3>
    ...
    <section class="ftco-section bg-light">
    	...
    	<div class="container-fluid">
    		<div class="row">
    			<c:forEach  var="trip" items="${TRIP_LIST_ACTIVE}" varStatus="count">
    				<c:if test="${count.index < 5}">
    					<div class="col-sm col-md-6 col-lg ftco-animate">
    					<div class="destination">
    						<a href="${trip.desc_url }"  target="_blank" class="img img-2 d-flex justify-content-center align-items-center" style="background-image: url(${trip.img_url});">
    							<div class="icon d-flex justify-content-center align-items-center">
    								<span class="icon-search2"></span>
    							</div>
    						</a>
    						<div class="text p-3">
    							<div class="d-flex">
	    							...
	    							<div class="two">
	    								<span class="price">${trip.price } million vnd</span>
    								</div>
    							</div>
    							<p>Far far away, behind the word mountains, far from the countries</p>
    							<p class="days"><span>Start date: ${trip.startDate }</span></p>
    							<p class="days"><span>End date: ${trip.endDate }</span></p>
    							<hr>
    							<p class="bottom-area d-flex">
    								<span><i class="icon-map-o"></i> ${trip.address }</span> 
    								<span class="ml-auto"><a href="${trip.desc_url }" alt="${trip.tripName }" target="_blank" alt="${trip.tripName }">Discover</a></span>
    							</p>
    						</div>
    					</div>
    				</div>
