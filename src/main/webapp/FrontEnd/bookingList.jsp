...
<html lang="en">
  <head>
    ...
    <link rel="stylesheet" type="text/css" href="${pageContext.request.contextPath }/FrontEnd/css/css/dataList.css">
  </head>
  <body>
  ...
  <nav class="navbar navbar-expand-lg navbar-dark ftco_navbar bg-dark ftco-navbar-light" id="ftco-navbar">
          ...
          <c:choose>
          	<c:when test="${isLogin }">
          		<form action="${pageContext.request.contextPath}/PageController" method="get">
          			...
          			<input style="background-color:transparent" class="cta btn btn-sm btn-dark nav-item nav-link mr-3 mt-1 active" type="submit" name="bookingList" value="Booking List">
          		</form>
          	</c:when>
          	<c:otherwise>
          		<li class="nav-item cta active"><a href="login.jsp" class="nav-link"><span>Booking List</span></a></li>
          	</c:otherwise>
          </c:choose>
      ...
      <div class="container">
        <div class="row no-gutters slider-text js-fullheight align-items-center justify-content-center" data-scrollax-parent="true">
          <div class="col-md-9 ftco-animate text-center" data-scrollax=" properties: { translateY: '70%' }">
            ...
            <h1 class="mb-3 bread" data-scrollax="properties: { translateY: '30%', opacity: 1.6 }">Review your booking list</h1>
          </div>
        </div>
      </div>
    </div>
	...
	<div class="container">
		...
		<c:forEach var="booking" items="${BOOKING_LIST}" varStatus="count">
			<tr>
				<td>${count.count }</td>
